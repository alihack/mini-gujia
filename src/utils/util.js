...
const dataController = (ele) => {
	return new Promise(resolve => {
		...
		switch (ele.orientation) {
			case '南':
				sourceAnalyze = '采光充足，通风好，冬暖夏凉，但是相对均价较高。'
				break
			case '东南':
				sourceAnalyze = '采光充足，冬季暖和，但通风略显不足，所以容易潮湿。'
				break
			case '东':
				sourceAnalyze = '上午阳光充足，采光较好，通风相对较差。'
				break
			case '西南':
				sourceAnalyze = '除了早晨之外，其余采光时间较好，但四季通风都较差，且有西晒，冬季偏冷。'
				break
			case '西':
				sourceAnalyze = '通风较好，但夏季西晒严重。'
				break
			case '东北':
				sourceAnalyze = '早晨会有阳光，冬季会有些寒冷。'
				break
			case '西北':
				sourceAnalyze = '均价比较低，但需要忍受西晒，大部分的房间都没有阳光的照射。'
				break
			case '北':
				sourceAnalyze = '夏季凉爽，在采光上具有劣势，且冬季阴冷。'
				break
		}
		const storeyNum = parseFloat(ele.storey.slice(0, ele.storey.indexOf('层')))
		switch (true) {
			case 1 <= storeyNum && storeyNum <= 4:
				sourceAnalyze += '低楼层出行更方便，适合有老人、儿童的家庭。但通风、采光较差，噪音较大且易受潮。'
				break
			case 5 <= storeyNum && storeyNum <= 8:
				sourceAnalyze += '黄金楼层，兼顾出行与采光通风，居住品质较高，视野较好。'
				break
			case 9 <= storeyNum && storeyNum <= 11:
				sourceAnalyze += '俗称扬灰层，空气中灰尘含量较高，但视野通风良好。'
				break
			case 12 <= storeyNum && storeyNum <= 18:
				sourceAnalyze += '采光优秀，通风、视野良好，居住质量较高，但老人出行或有不便。'
				break
			case 19 <= storeyNum:
				sourceAnalyze += '视野绝佳，空气清新，但风力较大，或许存在冬冷夏热的可能。'
				break
		}
		const acreage = parseFloat(ele.acreage)
		switch (true) {
			case 0 <= acreage && acreage <= 49:
				sourceAnalyze += '该房屋适合单身人士，装修居住成本较低，为缺乏资金的年轻人的首选。'
				break
			case 50 <= acreage && acreage <= 89:
				sourceAnalyze += '作为过渡型的小户型，适合资金不足的首次置业人群以及刚需'
				break
			case 90 <= acreage && acreage <= 139:
				sourceAnalyze += '该户型属于上面上的主流户型，作为市场刚需产品，保值能力较强。'
				break
			case 140 <= acreage:
				sourceAnalyze += '该房屋属于改善类大户型，居住惬意，适合资金充裕的人群。'
				break
		}
